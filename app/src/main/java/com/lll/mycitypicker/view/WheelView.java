...
package com.lll.mycitypicker.view;
...
import com.lll.mycitypicker.view.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new int[] { 0x55aaaaaa,
			0x33ffffff, 0x55E9E9E9 };
